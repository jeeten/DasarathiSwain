				...
				<div id="navigation" class="collapse navbar-collapse flex-column" >
					...
					<ul class="navbar-nav flex-column text-left">
						...
						<li class="nav-item active">
							<a class="nav-link" href="services.php"><i class="fas fa-briefcase fa-fw mr-2"></i>Services &amp; Pricing<span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
	...
	<div class="main-wrapper">
		<section class="cta-section theme-bg-light py-5">
			<div class="container text-center single-col-max-width">
				...
				<div class="intro">
					<p>I have 10+ years of development experience building software for the web and mobile devices. You can take a look at my <a href="portfolio.php" target="_blank">project portfolio</a> and <a href="resume.php" target="_blank">online resume</a> to find out more about my skills and experiences.</p>
