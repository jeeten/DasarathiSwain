		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center">
				<div class="banner-content col-lg-6 col-md-12 justify-content-center ">
					...
					<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.7s">Dasarathi Swain</h1>
					<div class="designation mb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay="2.1s">
						Senior Backend
						<span class="designer">Developer</span>
						and Network
						<span class="developer">Engineer</span>
					</div>
				...
				<div class="col-lg-6">
					<div class="filters">
						<ul>
							...
							<li data-filter=".branding">Project 1</li>
							<li data-filter=".creative">Project 2</li>
							<li data-filter=".web-design">Project 3</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row mt-80">
				<div class="col-lg-4 col-md-4">
					<div class="contact-box">
						<h4>+91 99303 35502</h4>
					</div>
				</div>
				<div class="col-lg-4 col-md-4">
					<div class="contact-box">
						<h4>info@dasarathiswain.com</h4>
					</div>
				</div>
				<div class="col-lg-4 col-md-4">
					<div class="contact-box">
						<h4>dasarathiswain@gmail.com</h4>
					</div>
				</div>
			</div>
